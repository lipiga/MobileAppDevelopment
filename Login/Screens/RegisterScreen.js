...
const RegisterScreen = () => {
  ...
  const onRegister = async (e) => {
    ...
    try {
      const response = await axios.post("http://192.168.1.5:4000/api/user/register", payload, {
    ...
    >
      <View style={styles.innerContainer}>
        ...
        <View style={styles.inputContainer}>
          <Ionicons name="person-outline" size={20} color="#b8a1d1" style={styles.inputIcon} />
          <TextInput
            style={styles.input}
            value={name}
